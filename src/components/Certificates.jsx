...
const Certificates = () => {
  ...
  const certificates = [
    {
      img: "/assets/certificates/3mtt.png",
      title: "Certificate of Completion - 3MTT",
      desc: "For the successful completion of the 3MTT training program.",
    },
    {
      img: "/assets/certificates/TSAcademy.png",
      title: "Certificate of Completion - TS Academy",
      desc: "For the successful completion of the TS Academy training program.",
    },
    {
      ...
      <div className="container">
        <div className="row justify-content-center mb-5">
          <div className="col-12 text-center">
            ...
            >
              A focused selection of certifications relevant to my work and
        ...
        <div className="row g-4">
          {certificates.slice(0, 9).map((cert, index) => (
            <div
              key={index}
            ...
            >
              ...
              >
                ...
                />
                <div
                  className="certificate-overlay position-absolute bottom-0 start-0 w-100 p-4 translate-y-full transition-transform duration-300 group-hover-translate-y-0"
                  style={{
                    background:
                      "linear-gradient(to top, rgba(17, 24, 39, 0.95) 0%, rgba(17, 24, 39, 0.8) 70%, transparent 100%)",
                  }}
                >
